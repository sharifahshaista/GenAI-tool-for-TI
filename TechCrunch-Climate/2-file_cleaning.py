...
There are several duplicated Markdown files after crawling, this is due to the website's organisation 
of articles where categories overlap one another i.e. an article can be in both 'climate' and 'transportation' categories.
This script will remove the duplicated Markdown files.
"""
...
if __name__ == "__main__":
    ...
    folder_path = "/Users/sharifahshaista/GenAI-for-TI/techcrunch-climate/techcrunch_crawl_output"
